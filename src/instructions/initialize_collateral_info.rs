...
impl InitializeCollateralInfo {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = InitializeCollateralInfoInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> InitializeCollateralInfoCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn global_config(&mut self, global_config: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn coll_info(&mut self, coll_info: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
