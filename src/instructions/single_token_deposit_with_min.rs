...
impl SingleTokenDepositWithMin {
  pub fn instruction(&self, args: SingleTokenDepositWithMinInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SingleTokenDepositWithMinInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = SingleTokenDepositWithMinInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SingleTokenDepositWithMinInstructionData {
            discriminator: [u8; 8],
                  }

impl SingleTokenDepositWithMinInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [250, 142, 102, 160, 72, 12, 83, 139],
                                              }
  }
}

impl Default for SingleTokenDepositWithMinInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SingleTokenDepositWithMinInstructionArgs {
                  pub token_a_min_post_deposit_balance: u64,
                pub token_b_min_post_deposit_balance: u64,
      }


/// Instruction builder for `SingleTokenDepositWithMin`.
///
/// ### Accounts:
///
...
pub struct SingleTokenDepositWithMinBuilder {
...
impl SingleTokenDepositWithMinBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SingleTokenDepositWithMin {
          ...
          let args = SingleTokenDepositWithMinInstructionArgs {
  ...
  /// `single_token_deposit_with_min` CPI accounts.
  pub struct SingleTokenDepositWithMinCpiAccounts<'a, 'b> {
...
/// `single_token_deposit_with_min` CPI instruction.
pub struct SingleTokenDepositWithMinCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SingleTokenDepositWithMinInstructionArgs,
  }

impl<'a, 'b> SingleTokenDepositWithMinCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SingleTokenDepositWithMinCpiAccounts<'a, 'b>,
              args: SingleTokenDepositWithMinInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              user: accounts.user,
...
/// Instruction builder for `SingleTokenDepositWithMin` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` user
...
#[derive(Clone, Debug)]
pub struct SingleTokenDepositWithMinCpiBuilder<'a, 'b> {
  instruction: Box<SingleTokenDepositWithMinCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SingleTokenDepositWithMinCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SingleTokenDepositWithMinCpiBuilderInstruction {
      __program: program,
              user: None,
              strategy: None,
              global_config: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = SingleTokenDepositWithMinCpi {
...
#[derive(Clone, Debug)]
struct SingleTokenDepositWithMinCpiBuilderInstruction<'a, 'b> {
