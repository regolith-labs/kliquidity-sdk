...
impl SingleTokenDepositAndInvestWithMin {
  pub fn instruction(&self, args: SingleTokenDepositAndInvestWithMinInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SingleTokenDepositAndInvestWithMinInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = SingleTokenDepositAndInvestWithMinInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SingleTokenDepositAndInvestWithMinInstructionData {
            discriminator: [u8; 8],
                  }

impl SingleTokenDepositAndInvestWithMinInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [118, 134, 143, 192, 188, 21, 131, 17],
                                              }
  }
}

impl Default for SingleTokenDepositAndInvestWithMinInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SingleTokenDepositAndInvestWithMinInstructionArgs {
                  pub token_a_min_post_deposit_balance: u64,
                pub token_b_min_post_deposit_balance: u64,
      }


/// Instruction builder for `SingleTokenDepositAndInvestWithMin`.
///
/// ### Accounts:
///
...
pub struct SingleTokenDepositAndInvestWithMinBuilder {
            user: Option<solana_program::pubkey::Pubkey>,
                ...
                event_authority: Option<solana_program::pubkey::Pubkey>,
                        token_a_min_post_deposit_balance: Option<u64>,
                token_b_min_post_deposit_balance: Option<u64>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl SingleTokenDepositAndInvestWithMinBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
    pub fn event_authority(&mut self, event_authority: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn token_a_min_post_deposit_balance(&mut self, token_a_min_post_deposit_balance: u64) -> &mut Self {
        self.token_a_min_post_deposit_balance = Some(token_a_min_post_deposit_balance);
        self
      }
                #[inline(always)]
      pub fn token_b_min_post_deposit_balance(&mut self, token_b_min_post_deposit_balance: u64) -> &mut Self {
        self.token_b_min_post_deposit_balance = Some(token_b_min_post_deposit_balance);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SingleTokenDepositAndInvestWithMin {
          ...
          let args = SingleTokenDepositAndInvestWithMinInstructionArgs {
                                                              token_a_min_post_deposit_balance: self.token_a_min_post_deposit_balance.clone().expect("token_a_min_post_deposit_balance is not set"),
                                                                  token_b_min_post_deposit_balance: self.token_b_min_post_deposit_balance.clone().expect("token_b_min_post_deposit_balance is not set"),
                                    };
  ...
  /// `single_token_deposit_and_invest_with_min` CPI accounts.
  pub struct SingleTokenDepositAndInvestWithMinCpiAccounts<'a, 'b> {
...
/// `single_token_deposit_and_invest_with_min` CPI instruction.
pub struct SingleTokenDepositAndInvestWithMinCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SingleTokenDepositAndInvestWithMinInstructionArgs,
  }

impl<'a, 'b> SingleTokenDepositAndInvestWithMinCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SingleTokenDepositAndInvestWithMinCpiAccounts<'a, 'b>,
              args: SingleTokenDepositAndInvestWithMinInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              user: accounts.user,
...
/// Instruction builder for `SingleTokenDepositAndInvestWithMin` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` user
          ...
          ///   29. `[]` instruction_sysvar_account
                ///   30. `[optional]` event_authority
#[derive(Clone, Debug)]
pub struct SingleTokenDepositAndInvestWithMinCpiBuilder<'a, 'b> {
  instruction: Box<SingleTokenDepositAndInvestWithMinCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SingleTokenDepositAndInvestWithMinCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SingleTokenDepositAndInvestWithMinCpiBuilderInstruction {
      __program: program,
              user: None,
              strategy: None,
              global_config: None,
              ...
              event_authority: None,
                                            token_a_min_post_deposit_balance: None,
                                token_b_min_post_deposit_balance: None,
...
#[inline(always)]
    pub fn event_authority(&mut self, event_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn token_a_min_post_deposit_balance(&mut self, token_a_min_post_deposit_balance: u64) -> &mut Self {
        self.instruction.token_a_min_post_deposit_balance = Some(token_a_min_post_deposit_balance);
        self
      }
                #[inline(always)]
      pub fn token_b_min_post_deposit_balance(&mut self, token_b_min_post_deposit_balance: u64) -> &mut Self {
        self.instruction.token_b_min_post_deposit_balance = Some(token_b_min_post_deposit_balance);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SingleTokenDepositAndInvestWithMinInstructionArgs {
                                                              token_a_min_post_deposit_balance: self.instruction.token_a_min_post_deposit_balance.clone().expect("token_a_min_post_deposit_balance is not set"),
                                                                  token_b_min_post_deposit_balance: self.instruction.token_b_min_post_deposit_balance.clone().expect("token_b_min_post_deposit_balance is not set"),
                                    };
        let instruction = SingleTokenDepositAndInvestWithMinCpi {
...
#[derive(Clone, Debug)]
struct SingleTokenDepositAndInvestWithMinCpiBuilderInstruction<'a, 'b> {
