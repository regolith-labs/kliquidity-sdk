...
impl SingleTokenDepositAndInvestWithMin {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SingleTokenDepositAndInvestWithMinInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl SingleTokenDepositAndInvestWithMinBuilder {
    ...
    #[inline(always)]
    pub fn token_a_min_post_deposit_balance(
        &mut self,
        token_a_min_post_deposit_balance: u64,
    ) -> &mut Self {
        self.token_a_min_post_deposit_balance = Some(token_a_min_post_deposit_balance);
        self
    }
    #[inline(always)]
    pub fn token_b_min_post_deposit_balance(
        &mut self,
        token_b_min_post_deposit_balance: u64,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = SingleTokenDepositAndInvestWithMinInstructionArgs {
            token_a_min_post_deposit_balance: self
                .token_a_min_post_deposit_balance
                .clone()
                .expect("token_a_min_post_deposit_balance is not set"),
            token_b_min_post_deposit_balance: self
                .token_b_min_post_deposit_balance
                .clone()
                .expect("token_b_min_post_deposit_balance is not set"),
        };
