...
impl CollectFeesAndRewards {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = CollectFeesAndRewardsInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
    pub fn reward2_vault(&mut self, reward2_vault: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault0(&mut self, pool_reward_vault0: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.pool_reward_vault0 = Some(pool_reward_vault0);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault1(&mut self, pool_reward_vault1: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.pool_reward_vault1 = Some(pool_reward_vault1);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault2(&mut self, pool_reward_vault2: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CollectFeesAndRewards {
                              user: self.user.expect("user is not set"),
                                        ...
                                        pool_reward_vault0: self.pool_reward_vault0.expect("pool_reward_vault0 is not set"),
                                        pool_reward_vault1: self.pool_reward_vault1.expect("pool_reward_vault1 is not set"),
                                        pool_reward_vault2: self.pool_reward_vault2.expect("pool_reward_vault2 is not set"),
...
#[inline(always)]
    pub fn reward2_vault(&mut self, reward2_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault0(&mut self, pool_reward_vault0: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_reward_vault0 = Some(pool_reward_vault0);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault1(&mut self, pool_reward_vault1: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_reward_vault1 = Some(pool_reward_vault1);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn pool_reward_vault2(&mut self, pool_reward_vault2: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          pool_reward_vault0: self.instruction.pool_reward_vault0.expect("pool_reward_vault0 is not set"),
                  
          pool_reward_vault1: self.instruction.pool_reward_vault1.expect("pool_reward_vault1 is not set"),
                  
          pool_reward_vault2: self.instruction.pool_reward_vault2.expect("pool_reward_vault2 is not set"),
