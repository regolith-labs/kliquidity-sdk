...
impl OpenLiquidityPosition {
  pub fn instruction(&self, args: OpenLiquidityPositionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: OpenLiquidityPositionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = OpenLiquidityPositionInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
    pub fn event_authority(&mut self, event_authority: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
            ...
            #[inline(always)]
    pub fn consensus_account(&mut self, consensus_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OpenLiquidityPosition {
                              admin_authority: self.admin_authority.expect("admin_authority is not set"),
                                        ...
                                        consensus_account: self.consensus_account.expect("consensus_account is not set"),
                      };
...
#[inline(always)]
    pub fn event_authority(&mut self, event_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn consensus_account(&mut self, consensus_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          consensus_account: self.instruction.consensus_account.expect("consensus_account is not set"),
                          __args: args,
            };
