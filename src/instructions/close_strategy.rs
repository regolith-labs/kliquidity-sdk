...
impl CloseStrategyBuilder {
  pub fn new() -> Self {
    ...
    pub fn strategy(&mut self, strategy: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn old_position_or_base_vault_authority(&mut self, old_position_or_base_vault_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.old_position_or_base_vault_authority = Some(old_position_or_base_vault_authority);
                    self
    }
            #[inline(always)]
    pub fn old_position_mint_or_base_vault_authority(&mut self, old_position_mint_or_base_vault_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.old_position_mint_or_base_vault_authority = Some(old_position_mint_or_base_vault_authority);
                    self
    }
            #[inline(always)]
    pub fn old_position_token_account_or_base_vault_authority(&mut self, old_position_token_account_or_base_vault_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.old_position_token_account_or_base_vault_authority = Some(old_position_token_account_or_base_vault_authority);
                    self
    }
            #[inline(always)]
    pub fn old_tick_array_lower_or_base_vault_authority(&mut self, old_tick_array_lower_or_base_vault_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.old_tick_array_lower_or_base_vault_authority = Some(old_tick_array_lower_or_base_vault_authority);
                    self
    }
            #[inline(always)]
    pub fn old_tick_array_upper_or_base_vault_authority(&mut self, old_tick_array_upper_or_base_vault_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.old_tick_array_upper_or_base_vault_authority = Some(old_tick_array_upper_or_base_vault_authority);
                    self
    }
            #[inline(always)]
...
#[inline(always)]
    pub fn reward2_vault(&mut self, reward2_vault: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward0_vault(&mut self, kamino_reward0_vault: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.kamino_reward0_vault = Some(kamino_reward0_vault);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward1_vault(&mut self, kamino_reward1_vault: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.kamino_reward1_vault = Some(kamino_reward1_vault);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward2_vault(&mut self, kamino_reward2_vault: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.kamino_reward2_vault = Some(kamino_reward2_vault);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward0_ata(&mut self, user_reward0_ata: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_reward0_ata = Some(user_reward0_ata);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward1_ata(&mut self, user_reward1_ata: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_reward1_ata = Some(user_reward1_ata);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward2_ata(&mut self, user_reward2_ata: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_reward2_ata = Some(user_reward2_ata);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward0_ata(&mut self, user_kamino_reward0_ata: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_kamino_reward0_ata = Some(user_kamino_reward0_ata);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward1_ata(&mut self, user_kamino_reward1_ata: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_kamino_reward1_ata = Some(user_kamino_reward1_ata);
                    self
    }
            /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward2_ata(&mut self, user_kamino_reward2_ata: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CloseStrategy {
                              admin_authority: self.admin_authority.expect("admin_authority is not set"),
                                        ...
                                        old_position_or_base_vault_authority: self.old_position_or_base_vault_authority.expect("old_position_or_base_vault_authority is not set"),
                                        old_position_mint_or_base_vault_authority: self.old_position_mint_or_base_vault_authority.expect("old_position_mint_or_base_vault_authority is not set"),
                                        old_position_token_account_or_base_vault_authority: self.old_position_token_account_or_base_vault_authority.expect("old_position_token_account_or_base_vault_authority is not set"),
                                        old_tick_array_lower_or_base_vault_authority: self.old_tick_array_lower_or_base_vault_authority.expect("old_tick_array_lower_or_base_vault_authority is not set"),
                                        old_tick_array_upper_or_base_vault_authority: self.old_tick_array_upper_or_base_vault_authority.expect("old_tick_array_upper_or_base_vault_authority is not set"),
                                        ...
                                        kamino_reward0_vault: self.kamino_reward0_vault.expect("kamino_reward0_vault is not set"),
                                        kamino_reward1_vault: self.kamino_reward1_vault.expect("kamino_reward1_vault is not set"),
                                        kamino_reward2_vault: self.kamino_reward2_vault.expect("kamino_reward2_vault is not set"),
                                        ...
                                        user_kamino_reward0_ata: self.user_kamino_reward0_ata.expect("user_kamino_reward0_ata is not set"),
                                        user_kamino_reward1_ata: self.user_kamino_reward1_ata.expect("user_kamino_reward1_ata is not set"),
                                        user_kamino_reward2_ata: self.user_kamino_reward2_ata.expect("user_kamino_reward2_ata is not set"),
  ...
  pub struct CloseStrategyCpiAccounts<'a, 'b> {
              ...
              pub old_position_mint_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub old_position_token_account_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub old_tick_array_lower_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub old_tick_array_upper_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>,
  ...
  pub fn new(
    ...
    Self {
      __program: program,
              ...
              old_position_mint_or_base_vault_authority: accounts.old_position_mint_or_base_vault_authority,
              old_position_token_account_or_base_vault_authority: accounts.old_position_token_account_or_base_vault_authority,
              old_tick_array_lower_or_base_vault_authority: accounts.old_tick_array_lower_or_base_vault_authority,
              old_tick_array_upper_or_base_vault_authority: accounts.old_tick_array_upper_or_base_vault_authority,
              pool: accounts.pool,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.admin_authority.clone());
                        ...
                        account_infos.push(self.old_position_token_account_or_base_vault_authority.clone());
...
impl<'a, 'b> CloseStrategyCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn strategy(&mut self, strategy: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn old_position_or_base_vault_authority(&mut self, old_position_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_position_or_base_vault_authority = Some(old_position_or_base_vault_authority);
                    self
    }
      #[inline(always)]
    pub fn old_position_mint_or_base_vault_authority(&mut self, old_position_mint_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_position_mint_or_base_vault_authority = Some(old_position_mint_or_base_vault_authority);
                    self
    }
      #[inline(always)]
    pub fn old_position_token_account_or_base_vault_authority(&mut self, old_position_token_account_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_position_token_account_or_base_vault_authority = Some(old_position_token_account_or_base_vault_authority);
                    self
    }
      #[inline(always)]
    pub fn old_tick_array_lower_or_base_vault_authority(&mut self, old_tick_array_lower_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_tick_array_lower_or_base_vault_authority = Some(old_tick_array_lower_or_base_vault_authority);
                    self
    }
      #[inline(always)]
    pub fn old_tick_array_upper_or_base_vault_authority(&mut self, old_tick_array_upper_or_base_vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_tick_array_upper_or_base_vault_authority = Some(old_tick_array_upper_or_base_vault_authority);
                    self
    }
      #[inline(always)]
    ...
    pub fn token_b_mint(&mut self, token_b_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn reward0_vault(&mut self, reward0_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.reward0_vault = Some(reward0_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn reward1_vault(&mut self, reward1_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.reward1_vault = Some(reward1_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn reward2_vault(&mut self, reward2_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.reward2_vault = Some(reward2_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward0_vault(&mut self, kamino_reward0_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.kamino_reward0_vault = Some(kamino_reward0_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward1_vault(&mut self, kamino_reward1_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.kamino_reward1_vault = Some(kamino_reward1_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn kamino_reward2_vault(&mut self, kamino_reward2_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.kamino_reward2_vault = Some(kamino_reward2_vault);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward0_ata(&mut self, user_reward0_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_reward0_ata = Some(user_reward0_ata);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward1_ata(&mut self, user_reward1_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_reward1_ata = Some(user_reward1_ata);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_reward2_ata(&mut self, user_reward2_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_reward2_ata = Some(user_reward2_ata);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward0_ata(&mut self, user_kamino_reward0_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_kamino_reward0_ata = Some(user_kamino_reward0_ata);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward1_ata(&mut self, user_kamino_reward1_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_kamino_reward1_ata = Some(user_kamino_reward1_ata);
                    self
    }
      /// If rewards are uninitialized, pass this as strategy.
#[inline(always)]
    pub fn user_kamino_reward2_ata(&mut self, user_kamino_reward2_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn token_b_token_program(&mut self, token_b_token_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn system(&mut self, system: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          old_position_or_base_vault_authority: self.instruction.old_position_or_base_vault_authority.expect("old_position_or_base_vault_authority is not set"),
                  
          old_position_mint_or_base_vault_authority: self.instruction.old_position_mint_or_base_vault_authority.expect("old_position_mint_or_base_vault_authority is not set"),
                  
          old_position_token_account_or_base_vault_authority: self.instruction.old_position_token_account_or_base_vault_authority.expect("old_position_token_account_or_base_vault_authority is not set"),
                  
          old_tick_array_lower_or_base_vault_authority: self.instruction.old_tick_array_lower_or_base_vault_authority.expect("old_tick_array_lower_or_base_vault_authority is not set"),
                  
          old_tick_array_upper_or_base_vault_authority: self.instruction.old_tick_array_upper_or_base_vault_authority.expect("old_tick_array_upper_or_base_vault_authority is not set"),
          ...
          reward0_vault: self.instruction.reward0_vault.expect("reward0_vault is not set"),
                  
          reward1_vault: self.instruction.reward1_vault.expect("reward1_vault is not set"),
                  
          reward2_vault: self.instruction.reward2_vault.expect("reward2_vault is not set"),
                  
          kamino_reward0_vault: self.instruction.kamino_reward0_vault.expect("kamino_reward0_vault is not set"),
                  
          kamino_reward1_vault: self.instruction.kamino_reward1_vault.expect("kamino_reward1_vault is not set"),
                  
          kamino_reward2_vault: self.instruction.kamino_reward2_vault.expect("kamino_reward2_vault is not set"),
                  
          user_reward0_ata: self.instruction.user_reward0_ata.expect("user_reward0_ata is not set"),
                  
          user_reward1_ata: self.instruction.user_reward1_ata.expect("user_reward1_ata is not set"),
                  
          user_reward2_ata: self.instruction.user_reward2_ata.expect("user_reward2_ata is not set"),
                  
          user_kamino_reward0_ata: self.instruction.user_kamino_reward0_ata.expect("user_kamino_reward0_ata is not set"),
                  
          user_kamino_reward1_ata: self.instruction.user_kamino_reward1_ata.expect("user_kamino_reward1_ata is not set"),
                  
          user_kamino_reward2_ata: self.instruction.user_kamino_reward2_ata.expect("user_kamino_reward2_ata is not set"),
...
struct CloseStrategyCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            admin_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                old_position_mint_or_base_vault_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                old_position_token_account_or_base_vault_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                old_tick_array_lower_or_base_vault_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                old_tick_array_upper_or_base_vault_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
