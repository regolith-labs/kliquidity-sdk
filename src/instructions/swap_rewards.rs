...
impl SwapRewardsBuilder {
    ...
    #[inline(always)]
    pub fn user_reward_token_account(
        &mut self,
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SwapRewards {
            ...
            user_reward_token_account: self
                .user_reward_token_account
                .expect("user_reward_token_account is not set"),
        ...
        let args = SwapRewardsInstructionArgs {
            ...
            reward_collateral_id: self
                .reward_collateral_id
                .clone()
                .expect("reward_collateral_id is not set"),
            min_collateral_token_out: self
                .min_collateral_token_out
                .clone()
                .expect("min_collateral_token_out is not set"),
        };
...
impl<'a, 'b> SwapRewardsCpiBuilder<'a, 'b> {
    ...
    pub fn user_reward_token_account(
        &mut self,
        user_reward_token_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let args = SwapRewardsInstructionArgs {
            token_a_in: self
                ...
                .token_a_in
                .clone()
                .expect("token_a_in is not set"),
            token_b_in: self
                .instruction
                .token_b_in
                .clone()
                .expect("token_b_in is not set"),
            reward_index: self
                .instruction
                .reward_index
                .clone()
