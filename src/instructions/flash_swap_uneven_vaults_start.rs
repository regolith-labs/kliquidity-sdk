...
impl FlashSwapUnevenVaultsStart {
  pub fn instruction(&self, args: FlashSwapUnevenVaultsStartInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: FlashSwapUnevenVaultsStartInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = FlashSwapUnevenVaultsStartInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct FlashSwapUnevenVaultsStartInstructionData {
            discriminator: [u8; 8],
                  }

impl FlashSwapUnevenVaultsStartInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [129, 111, 174, 12, 10, 60, 149, 193],
                                              }
  }
}

impl Default for FlashSwapUnevenVaultsStartInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct FlashSwapUnevenVaultsStartInstructionArgs {
                  pub amount: u64,
                pub a_to_b: bool,
      }


/// Instruction builder for `FlashSwapUnevenVaultsStart`.
///
/// ### Accounts:
///
...
pub struct FlashSwapUnevenVaultsStartBuilder {
...
impl FlashSwapUnevenVaultsStartBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = FlashSwapUnevenVaultsStart {
          ...
          let args = FlashSwapUnevenVaultsStartInstructionArgs {
  ...
  /// `flash_swap_uneven_vaults_start` CPI accounts.
  pub struct FlashSwapUnevenVaultsStartCpiAccounts<'a, 'b> {
...
/// `flash_swap_uneven_vaults_start` CPI instruction.
pub struct FlashSwapUnevenVaultsStartCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: FlashSwapUnevenVaultsStartInstructionArgs,
  }

impl<'a, 'b> FlashSwapUnevenVaultsStartCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: FlashSwapUnevenVaultsStartCpiAccounts<'a, 'b>,
              args: FlashSwapUnevenVaultsStartInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `FlashSwapUnevenVaultsStart` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` swapper
          ...
          ///   19. `[]` consensus_account
#[derive(Clone, Debug)]
pub struct FlashSwapUnevenVaultsStartCpiBuilder<'a, 'b> {
  instruction: Box<FlashSwapUnevenVaultsStartCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> FlashSwapUnevenVaultsStartCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(FlashSwapUnevenVaultsStartCpiBuilderInstruction {
      __program: program,
              swapper: None,
              strategy: None,
              global_config: None,
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn swapper(&mut self, swapper: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = FlashSwapUnevenVaultsStartCpi {
...
#[derive(Clone, Debug)]
struct FlashSwapUnevenVaultsStartCpiBuilderInstruction<'a, 'b> {
